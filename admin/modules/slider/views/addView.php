                                                        ...
                                                        <div class="form-info-right form-info-item-wrap">
                                                            ...
                                                            <div class="info-wrap-form">
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <div class="list-slide">
                                                                                    <?php
                                                                                        $i=1;
                                                                                        foreach($listSlide as $slideItem) {
                                                                                            ?>
                                                                                                <div class="slide-item d-flex">
                                                                                                    <div class="slide-img">
                                                                                                        <span class="thumbNail">
                                                                                                            <img src="<?php echo $slideItem['slide_img'] ?>" alt="Slide">
                                                                                                        </span>
                                                                                                    </div>
                                                                                                    <div class="slide-info">
                                                                                                        <div class="form-group">
                                                                                                            <label for="sider-info-<?php echo $i ?>" class="primary-title">Số thứ tự</label>
                                                                                                            <input type="number" name="number[]" value="<?php echo $slideItem['slide_number'] ?>" min="1" class="form-control" id="slider-info-<?php echo $i ?>" placeholder="Số thứ tự của slide" autocomplete="off" spellcheck="false">
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            <?php 
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" min="1" value="<?php echo set_value("slide_number") ?>" name="slide_number" id="slide-number" class="form-control" autocomplete="off" spellcheck="false" placeholder="Nhập số thứ tự hiển thị của slide">
                                                                ...
                                                                <div class="form-group">
                                                                    <button type="submit" name="add_new_slide_btn" class="add-new-cate">Thêm mới danh mục</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
