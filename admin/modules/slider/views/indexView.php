                            ...
                            <div class="container-fluid">
                                <div class="grid-row">
                                    <div class="grid-column-7">
                                        <a href="<?php echo base_url("?mod=slider&action=add") ?>" class="view-action-add">
                                            <p class="w-100 h-100 d-flex align-items-center">
                                                <i class="fa fa-plus-circle mr-1" aria-hidden="true"></i>
                                                <span>Thêm slide</span>
                                            </p>
                                        </a>
                                        <a href="<?php echo base_url("?mod=slider&action=caption") ?>" class="view-action-add">
                                            <p class="w-100 h-100 d-flex align-items-center">
                                                <i class="fa fa-plus-circle mr-1" aria-hidden="true"></i>
                                                    ...
                                                    <table class="table-wrap">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <span class="thead-title">Số thứ tự</span>
                                                                </td>
                                                                <td>
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                $i=1;
                                                                foreach($listSlider as $slideItem) {
                                                                    ?>
                                                                        <tr data-slide-id="<?php echo $slideItem['slide_id'] ?>">
                                                                            <td>
                                                                                <input type="checkbox" name="checkItem" id="checkItem-<?php echo $slideItem['slide_id'] ?>">
                                                                            </td>
                                                                            <td>
                                                                            ...
                                                                            <td>
                                                                                <span class="thumbNail">
                                                                                    <img src="<?php echo $slideItem['slide_img'] ?>" alt="">
                                                                                </span>
                                                                            </td>
                                                                            <td>
                                                                                <span class="time_vl __value"><?php echo $slideItem['slide_number'] ?></span>
                                                                            </td>
                                                                            <td>
                                                                                <span class="__value" data-status='<?php echo $slideItem['status_current'] ?>'><?php echo formatStatus($slideItem['status_current']) ?></span>
                                                                            </td>
                                                                            <td>
                                                                                <span class="time_vl __value"><?php echo formatTime($slideItem['create_date']) ?></span>
                                                                            </td>
                                                                            <td>
                                                                                <span class="time_vl __value"><?php echo formatTime($slideItem['update_date']) ?></span>
                                                                            </td>
                                                                            <td>
                                                                                <div class="operation-list-setting d-flex align-items-center">
                                                                                    <a href="<?php echo base_url("?mod=slider&action=update&id={$slideItem['slide_id']}") ?>">
                                                                                        <button type="button" class="button" class="pd-setting" title="Edit" data-action='edi'>
