...
<head>
    ...
    <title>Admin | Danh sách showroom</title>
</head>
                                                    ...
                                                    <table class="table-wrap">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <span class="thead-title">Tên showroom</span>
                                                                </td>
                                                                <td>
                                                                    <span class="thead-title">Địa chỉ showroom</span>
                                                                </td>
                                                                <td>
                                                                    <span class="thead-title">Số điện thoại 1</span>
                                                                </td>
                                                                <td>
                                                                    <span class="thead-title">Số điện thoại 2</span>
                                                                </td>
                                                                <td>
                                                                    <span class="thead-title">Email showroom</span>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <span class="thead-title">Ngày cập nhật</span>
                                                                </td>
                                                                <td>
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                $i=1;
                                                                foreach($listDataShowroom as $showroomItem) {
                                                                    ?>
                                                                        <tr>
                                                                            <td data-id-showroom="<?php echo $showroomItem['showroom_id'] ?>">
                                                                                <input type="checkbox" name="checkItem" id="checkItem-<?php echo $showroomItem['showroom_id'] ?>">
                                                                            </td>
                                                                            <td>
                                                                                <span class="__value"><?php echo $i; ?></span>
                                                                            </td>
                                                                            <td>
                                                                                <a href="<?php echo base_url("?mod=aboutUs&action=updateShowroom&id={$showroomItem['showroom_id']}") ?>" class="view_vl __value"><?php echo $showroomItem['showroom_name'] ?></a>
                                                                            </td>
                                                                            <td>
                                                                                <a target="_blank" href="https://www.google.com/maps/place/<?php echo $showroomItem['showroom_address'] ?>" class="view_vl __value"><?php echo $showroomItem['showroom_address'] ?></a>
                                                                            </td>
                                                                            
                                                                            <td>
                                                                                <a target="_blank" href="tel:<?php echo $showroomItem['showroom_phone_1']; ?>" class="view_vl __value"><?php echo formatPhone($showroomItem['showroom_phone_1']); ?></a>
                                                                            </td>
                                                                            <td>
                                                                                <a target="_blank" href="tel:<?php echo $showroomItem['showroom_phone_2']; ?>" class="view_vl __value"><?php echo formatPhone($showroomItem['showroom_phone_2']); ?></a>
                                                                            </td>
                                                                            <td>
                                                                                <a target="_blank" href="mailTo:<?php echo $showroomItem['showroom_email']; ?>" class="view_vl __value"><?php echo $showroomItem['showroom_email']; ?></a>
                                                                            </td>
                                                                            <td>
                                                                                <span class="__value" data-status='<?php echo $showroomItem['status_current']; ?>'><?php echo formatStatus($showroomItem['status_current']); ?></span>
                                                                            </td>
                                                                            <td>
                                                                                <span class="time_vl __value"><?php echo formatTime($showroomItem['created_date']); ?></span>
                                                                            </td>
                                                                            <td>
                                                                                <span class="time_vl __value"><?php echo formatTime($showroomItem['update_date']); ?></span>
                                                                            </td>
                                                                            <td>
                                                                                <div class="operation-list-setting d-flex align-items-center">
                                                                                    <a href="<?php echo base_url("?mod=aboutUs&action=updateShowroom&id={$showroomItem['showroom_id']}") ?>">
