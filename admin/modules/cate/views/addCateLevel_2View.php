                                    ...
                                    <div class="grid-column-6">
                                        <div class="breadcrumb-left d-flex align-items-center">
                                            ...
                                            <div class="breadcrumb-ctn">
                                                <h4>Thêm danh mục cấp 2 cho sản phẩm</h4>
                                                    ...
                                                    <div class="grid-column-4">
                                                        <div class="form-info-right form-info-item-wrap">
                                                            ...
                                                            <div class="info-wrap-form">
                                                                <div class="form-group">
                                                                    <label for="cate-parent" class="primary-title">Chọn danh mục cấp 1</label>
                                                                        ...
                                                                        <?php
                                                                            if(!empty($listCateLevel_1)) {
                                                                                foreach($listCateLevel_1 as $cateItem) {
                                                                                    ?>
                                                                                        <option <?php if(!empty(set_value("parent_id"))) { if(set_value("parent_id") == $cateItem['id_cate']) { echo "selected"; } else { echo null; } } ?> value="<?php echo $cateItem['id_cate']; ?>"><?php echo $cateItem['title_cate'] ?></option>
                                                                                    <?php 
                                                                                }
                                                                            } else {
                                                                                ?>
                                                                                    <option value="">Chưa thêm danh mục cấp 1 nào</option>
                                                                                <?php 
                                                                            }
                                                                        ?>
                                                                    </select>
                                                                ...
                                                                <div class="form-group">
                                                                    <button type="submit" name="add_new_cate_level_2" class="add-new-cate">Thêm mới danh mục</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
