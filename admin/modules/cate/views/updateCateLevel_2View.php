                            ...
                            <div class="container-fluid">
                                <div class="grid-row">
                                    <div class="grid-column-3">
                                        <a href="<?php echo base_url("?mod=cate&controller=cateLevel_2&action=list") ?>" class="view-action-add">
                                            <p class="w-100 h-100 d-flex align-items-center">
                                                <i class="fa fa-plus-circle mr-1" aria-hidden="true"></i>
                                                <span>Danh sách D.mục cấp 2</span>
                                            </p>
                                        </a>
                                    </div>
                                    <div class="grid-column-3">
                                                                    ...
                                                                    <div class="form-info-left form-info-item-wrap">
                                                                        ...
                                                                        <div class="wrap-banner-form d-flex">
                                                                            <div class="banner-img-demo">
                                                                                <span class="thumbNail" style="width: 560px; height: 353px;">
                                                                                    <img id="img-thumbNail-inner" data-exist-img="false" src="<?php if(!empty(set_value("banner_img_thumbNail_url"))) { echo set_value("banner_img_thumbNail_url"); } else {echo $cateItem['img_banner'];}  ?>" alt="<?php if(!empty(set_value("title_cate"))) { echo set_value("title_cate"); } else { echo $cateItem['title_cate']; } ?>">
                                                                                    <input id="img-thumbNail-inner-url" name="banner_img_thumbNail_url" type="hidden" value="<?php if(!empty(set_value("banner_img_thumbNail_url"))) { echo set_value("banner_img_thumbNail_url"); } else {echo $cateItem['img_banner'];}  ?>">
                                                                                </span>
                                                                            </div>
                                                                ...
                                                                <div class="grid-column-4">
                                                                    <div class="form-info-right form-info-item-wrap">
                                                                        ...
                                                                        <div class="info-wrap-form">
                                                                            <div class="form-group">
                                                                                <label for="cate-parent" class="primary-title">Danh mục cấp 1</label>
                                                                                <select name="parent_id" id="cate-parent-id" class="form-control">
                                                                                    <option value="">--Chọn danh mục cấp 1--</option>
                                                                                    <?php
                                                                                        if(!empty($listCateLevel_1)) {
                                                                                            foreach($listCateLevel_1 as $cateItemlevel_1) {
                                                                                                ?>
                                                                                                    <option  <?php if(!empty(set_value("parent_id"))) { if(set_value("parent_id") == $cateItemlevel_1['id_cate']) { echo "selected"; } else { echo null; } } else { if($cateItemlevel_1['id_cate'] == $cateItem['parent_id']) { echo "selected"; } else { echo null; } } ?> value="<?php echo $cateItemlevel_1['id_cate'] ?>"><?php echo $cateItemlevel_1['title_cate'] ?></option>
                                                                                                <?php 
                                                                                            }
                                                                                        } else {
                                                                                            ?>
                                                                                                <option value="">--Không có danh mục cấp 1 nào--</option>
                                                                                            <?php 
                                                                                        }
                                                                                    ?>
                                                                                </select>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <button type="submit" name="update_new_cate_level_2_btn" class="add-new-cate">Cập nhật mới danh mục</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
