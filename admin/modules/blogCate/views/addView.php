                                                            ...
                                                            <div class="wrap-banner-form d-flex">
                                                                <div class="banner-img-demo">
                                                                    <span class="thumbNail" style="width: 328px;height: 328px;">
                                                                        <img id="img-thumbNail-inner" data-exist-img="false" src="./public/images/logo/img_prod.png" alt="">
                                                                        <input id="img-thumbNail-inner-url" name="banner_img_thumbNail_url" type="hidden" value="">
                                                                    </span>
                                                                </div>
                                                        ...
                                                        <div class="form-info-right form-info-item-wrap">
                                                            ...
                                                            <div class="info-wrap-form">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea name="desc_cate" id="desc-cate" class="form-control" spellcheck="false" style="height: 80px; width: 100%;" placeholder="Ghi mô tả danh mục"><?php echo set_value("desc_cate") ?></textarea>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="status_cate" class="form-control" id="status-cate">
                                                                        ...
                                                                        <option value="publish" <?php if(set_value("status") == 'publish') { echo "selected"; } else { echo null; } ?>>Hoạt động</option>
                                                                        <option value="pending" <?php if(set_value("status") == 'pending') { echo "selected"; } else { echo null; } ?>>Chờ Duyệt</option>
                                                                    </select>
                                                                </div>
                                                                <div class="form-group">
                                                                    <button type="submit" name="add_new_cate_blog" class="add-new-cate">Thêm mới danh mục</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
