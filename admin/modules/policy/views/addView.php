                                                    ...
                                                    <div class="grid-column-12">
                                                        <div class="form-info-right form-info-item-wrap">
                                                            <label for="info-cate-title" class="top-title d-flex align-items-center">
                                                                ...
                                                                <span>Thông tin về chính sách</span>
                                                            </label>
                                                            <div class="info-wrap-form">
                                                                <div class="form-group mb-2">
                                                                    <label for="title-policy" class="primary-title">Tên chính sách</label>
                                                                    <input type="text" name="title_policy" value="<?php echo set_value("title_policy") ?>" id="title-policy" class="form-control" placeholder="Tên chính sách" autocomplete="off" spellcheck="false">
                                                                    <?php echo form_error("title_policy") ?>
                                                                </div>
                                                                <div class="form-group mb-2">
                                                                    <label for="desc-policy" class="primary-title">Mô tả chính sách( dùng để seo )</label>
                                                                    <textarea type="text" name="desc_policy" id="desc-policy" class="form-control" placeholder="Mô tả chính sách" autocomplete="off" spellcheck="false"><?php echo set_value("desc_policy") ?></textarea>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea name="content_policy" class="ckeditor" id="content-policy" style="width: 100%; height: 500px;">
                                                                        <?php echo set_value("content_policy") ?>
                                                                    </textarea>
                                                                ...
                                                                <div class="form-group">
                                                                    <button type="submit" name="add_new_policy_btn" class="add-new-cate">Thêm chính sách mới</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
