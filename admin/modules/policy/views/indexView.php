                                    ...
                                    <div class="grid-column-6">
                                        <div class="breadcrumb-left d-flex align-items-center">
                                            ...
                                            <div class="breadcrumb-ctn">
                                                <h4>Danh sách chính sách công ty</h4>
                                                ...
                                                <div class="grid-column-12">
                                                    <table class="table-wrap">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                $i=1;
                                                                foreach($listPolicy as $policyItem) {
                                                                    ?>
                                                                        <tr data-id-policy="<?php echo $policyItem['policy_id'] ?>">
                                                                            <td>
                                                                                <input type="checkbox" name="checkItem" id="checkItem-<?php echo $policyItem['policy_id'] ?>" value="<?php echo $policyItem['policy_id'] ?>">
                                                                            </td>
                                                                            <td>
                                                                                <span class="__value"><?php echo $i; ?></span>
                                                                            </td>
                                                                            <td>
                                                                                <a href="<?php echo base_url("?mod=policy&action=update&id={$policyItem['policy_id']}") ?>" class="view_vl __value"><?php echo $policyItem['policy_title'] ?></a>
                                                                            </td>
                                                                            <td>
                                                                                <span class="__value" data-status='<?php echo $policyItem['status_current'] ?>'><?php echo formatStatus($policyItem['status_current']) ?></span>
                                                                            </td>
                                                                            <td>
                                                                                <span class="time_vl __value"><?php echo formatTime($policyItem['created_date']) ?></span>
                                                                            </td>
                                                                            <td>
                                                                                <span class="time_vl __value"><?php echo formatTime($policyItem['update_date']) ?></span>
                                                                            </td>
                                                                            <td>
                                                                                <div class="operation-list-setting d-flex align-items-center">
                                                                                    <a href="<?php echo base_url("?mod=policy&action=update&id={$policyItem['policy_id']}") ?>">
