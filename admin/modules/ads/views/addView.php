...
<head>
    ...
    <title>Admin | Thêm quảng cáo</title>
</head>
<style>
                                                            ...
                                                            <div class="wrap-banner-form d-flex" style="position: relative;">
                                                                <div class="banner-img-demo">
                                                                    <span class="thumbNail" style="width: 328px;height: 328px;">
                                                                        ...
                                                                        <input id="img-thumbNail-inner-url" name="banner_img_thumbNail_url" type="hidden" value="<?php if(!empty(set_value("banner_img_thumbNail_url"))) { echo set_value("banner_img_thumbNail_url"); } else { echo null; } ?>">
                                                                    </span>
                                                                </div>
                                                        ...
                                                        <div class="form-info-right form-info-item-wrap">
                                                            ...
                                                            <div class="info-wrap-form">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="ads_title" value="<?php if(!empty(set_value("ads_title"))) { echo set_value("ads_title"); } else { echo null; } ?>" id="ads-title" class="form-control" placeholder="Tiêu đề quảng cáo" autocomplete="off" spellcheck="false">
                                                                    <?php echo form_error("ads_title"); ?>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="ads-link" class="primary-title">Link quảng cáo</label>
                                                                    <input type="text" name="ads_link" value="<?php if(!empty(set_value("ads_link"))) { echo set_value("ads_link"); } else { echo null; } ?>" id="ads-link" class="form-control" placeholder="Link quảng cáo" autocomplete="off" spellcheck="false">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="status_ads" id="status-ads" class="form-control">
                                                                        ...
                                                                        <option value="publish" <?php if(!empty(set_value("status_ads"))) { if(set_value("status_ads") == 'publish') { echo "selected"; } else { echo null; } }  ?>>Hoạt động</option>
                                                                        <option value="pending" <?php if(!empty(set_value("status_ads"))) { if(set_value("status_ads") == 'pending') { echo "selected"; } else { echo null; } } ?>>Chờ duyệt</option>
                                                                    </select>
                                                                </div>
                                                                <div class="form-group">
                                                                        ...
                                                                        <ul class="list-space-appear">  
                                                                            <li>
                                                                                <label for="space-product">
                                                                                    <input type="checkbox" <?php if(!empty(set_value("space_product"))) { if(set_value("space_product") == '1') { echo "checked"; } else { echo null; } } ?> class="checkbox" name="space_product" value="1" id="space-product">
                                                                            ...
                                                                            <li>
                                                                                <label for="space-productCate">
                                                                                    <input type="checkbox" <?php if(!empty(set_value("space_productCate"))) { if(set_value("space_productCate") == '1') { echo "checked"; } else { echo null; } } ?> class="checkbox" name="space_productCate" value="1" id="space-productCate">
                                                                            ...
                                                                            <li>
                                                                                <label for="space-blog">
                                                                                    <input type="checkbox" <?php if(!empty(set_value("space_blog"))) { if(set_value("space_blog") == '1') { echo "checked"; } else { echo null; } } ?> class="checkbox" name="space_blog" value="1" id="space-blog">
                                                                            ...
                                                                            <li>
                                                                                <label for="space-blogCate">
                                                                                    <input type="checkbox" <?php if(!empty(set_value("space_blogCate"))) { if(set_value("space_blogCate") == '1') { echo "checked"; } else { echo null; } } ?> class="checkbox" name="space_blogCate" value="1" id="space-blogCate">
                                                                ...
                                                                <div class="form-group">
                                                                    <button type="submit" name="add_new_ads_btn" class="add-new-cate">Tạo quảng cáo</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
