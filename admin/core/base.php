...
function get_pagination($totalPage, $page, $url){
    if($totalPage>0) {
        $disablePrev = null;
        $disableNext = null;
        if($page <= 1) {
        ...
        if($page >= $totalPage) {
            ...
            $disableNext = null;
            $urlNext = $url."&page=".($page+1)."";
        }
        ?>
            <div class="pagination-wrap">
                <ul class="pagination-list">
                    <li>
                        <a href="<?= $urlPrev; ?>" class="prev <?= $disablePrev; ?>">
                    ...
                    <?php
                        for ($i=0; $i < $totalPage; $i++) { 
                            $active = null;
                            $active = $page == $i+1 ? "active" : null;
                            ?>
                                <li>
                                    <a href="<?= $url."&page=".($i+1).""; ?>" class="normal <?= $active ?>">
                                        <span><?= $i+1; ?></span>
                                    </a>
                                </li>
                            <?php
                    ...
                    ?>
                    <li>
                        <a href="<?= $urlNext; ?>" class="next <?= $disableNext; ?>">
